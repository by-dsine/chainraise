    ...
    <div className="relative overflow-hidden bg-white">
      ...
      <div className="mt-4 lg:grid lg:grid-cols-12 lg:gap-x-5">
        ...
        <div className="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
          <form action="/api/account/updateProfile" method="POST">
            <input {...register("id")} type="text" className='hidden' defaultValue={session?.user.uid}/>
            ...
            <div className="shadow sm:overflow-hidden sm:rounded-md">
              <div className="space-y-6 bg-white py-6 px-4 sm:p-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Click the button below to submit your investor forms. This
                    information must be filled out before you invest in an
                    offer. This information will only be visible to you and
                    regulatory bodies.
                  </p>
                </div>
              </div>
              <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                <Link href="/account/investor">
                  <button
                    type="submit"
                    className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
