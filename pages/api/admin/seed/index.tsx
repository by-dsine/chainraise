...
export default async function newOffering(
   ...
   await prisma.offering.create({
      data: {
         ...
         industry: 'Technology',
         description:
            "This is a very long description for a test offering. My goodness it goes on. And wouldn't you know, it doesn't even say that much. Like wow this is a lot of words to say absolutely nothing. And here you are, at the end of the line, and no way to get all that time back.",
         shortDescription: "This description isn't much but it's honest work.",
         disclosure: 'None of this means anything.',
         summary:
            "Oh boy here we go again. Luckily it's not nearly as long but still it's annoying to go on and on when there's nothing to be gained by going on.",
         type: 'Equity',
         statusId: 3, // Active
      },
   });
