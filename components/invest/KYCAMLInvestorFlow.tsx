         ...
         {!kycStateLoading && investorForm.kycStatus && (
            <div className="flex flex-col">
               ...
               <h1 className="pt-4 text-lg">
                  KYC Status: {investorForm.kycStatus}
               </h1>
               <h1 className="pt-4 text-lg">
                  AMC Status: {investorForm.amlStatus}
               </h1>
            </div>
         )}
         <form onSubmit={onSubmit}>
            <div className="pt-4 sm:pt-6">
               ...
               <p className="mt-1 max-w-3xl text-sm text-gray-500">
                  Verify the information submitted below to submit for KYC/AML
                  check. Click{' '}
