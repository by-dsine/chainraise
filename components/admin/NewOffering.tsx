...
import { OrganizationPrimaryIssuerForm } from '../../types/typings'
          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm text-gray-600">
                This is the primary contact of this issuer. They will be the
                admin of the offering and the organization. These settings can
                be changed later.
              </p>
            </div>
          </div>
